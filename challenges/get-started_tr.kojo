// todo: original: ~/src/kojo/git/kojo/src/main/resources/challenge/
...
// #include runner_tr.kojo
/* #include /challenge/runner_tr.kojo   //todo */
...
lazy val levelsHelp = Eşlem(
    ...
    Neler öğreniyoruz:
      ...
      <ul>
          ...
          <li><em>Araçlar</em> – Açıölçer ve cetveli aç/kapat. 
            Her iki aracı da kaydırıp çevirebilirsin. Fareyle tıklayarak sürü. Döndürmek için Shift tuşuna basarak kaydır.
    ...
    Neler öğreniyoruz:
        <ul>
            ...
            <li>İç içe geçmiş <tt>yinele</tt> komutları</li>
            <li>Çözümsel düşünüş</li>
            <li>Yeni öğrenilen kavramların pekiştirilmesi</li>
        </ul>
    </div>,
