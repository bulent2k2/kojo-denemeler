...
durum sınıf DizinİçindeBelki[T](ne: Dizin[Belki[T]]) {
  tanım map[S](f: T => S): DizinİçindeBelki[S] = DizinİçindeBelki(ne.işle(_.işle(f)))
  
  tanım flatMap[S](f: T => DizinİçindeBelki[S]): DizinİçindeBelki[S] = DizinİçindeBelki(
    ne.düzİşle {
      durum Biri(a) => f(a).ne
